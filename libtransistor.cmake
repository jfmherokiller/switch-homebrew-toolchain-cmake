...
set(DEVKITPRO2 "/opt/libtransistor")
set(NX 2)
...
set(SYS_INCLUDES "-isystem ${DEVKITPRO2}/include/")
set(CPP_INCLUDES "-isystem ${DEVKITPRO2}/include/c++/v1/")
set(LDFLAGMAIN "-Bsymbolic --shared --no-gc-sections --eh-frame-hdr --no-undefined -T ${DEVKITPRO2}/link.T -L ${DEVKITPRO2}/lib/")
set(LDFLAG_LIBRARY "--shared --no-gc-sections --eh-frame-hdr -T ${DEVKITPRO2}/link.T -L ${DEVKITPRO2}/lib/ -Bdynamic")
...
#set(PKG_CONFIG "${DEVKITPRO2}/portlibs/bin/aarch64-none-elf-pkg-config" CACHE STRING "")

set(CMAKE_C_FLAGS "${CC_FLAGS}")
set(CMAKE_CXX_FLAGS "${CXX_FLAGS}" CACHE STRING "C++ flags")


set(LIB_DEP_COMPILER_RT_BUILTINS "${DEVKITPRO2}/lib/libclang_rt.builtins-aarch64.a")
set(LIB_DEP_NEWLIB_LIBC "${DEVKITPRO2}/lib/libc.a")
set(LIB_DEP_NEWLIB_LIBM "${DEVKITPRO2}/lib/libm.a")
set(LIB_DEP_PTHREAD "${DEVKITPRO2}/lib/libpthread.a")
set(LIB_DEP_LIBLZMA "${DEVKITPRO2}/lib/liblzma.a")
set(LIB_DEP_LIBCXX "${DEVKITPRO2}/lib/libc++.a")
set(LIB_DEP_LIBCXXABI "${DEVKITPRO2}/lib/libc++abi.a")
set(LIB_DEP_LIBUNWIND "${DEVKITPRO2}/lib/libunwind.a")
set(CXX_LIB_DEPS "${LIB_DEP_LIBCXX} ${LIB_DEP_LIBCXXABI} ${LIB_DEP_LIBUNWIND}")
set(LIBTRANSISTOR_COMMON_LIB_DEPS "${LIB_DEP_NEWLIB_LIBC} ${LIB_DEP_NEWLIB_LIBM} ${LIB_DEP_COMPILER_RT_BUILTINS} ${LIB_DEP_PTHREAD} ${LIB_DEP_LIBLZMA} ${CXX_LIB_DEPS} ${DEVKITPRO2}/link.T")
set(LIBTRANSISTOR_COMMON_LIBS "${LIBTRANSISTOR_COMMON_LIB_DEPS} # for older Makefiles")
set(LIBTRANSISTOR_NRO_DEP "${DEVKITPRO2}/lib/libtransistor.nro.a")
set(LIBTRANSISTOR_NSO_DEP "${DEVKITPRO2}/lib/libtransistor.nso.a")
set(LIBTRANSISTOR_NRO_LIB "${LIBTRANSISTOR_NRO_DEP}")
set(LIBTRANSISTOR_NSO_LIB "${LIBTRANSISTOR_NSO_DEP}")
set(LIBTRANSISTOR_NRO_DEPS "${DEVKITPRO2}/lib/libtransistor.nro.a ${LIBTRANSISTOR_COMMON_LIB_DEPS}")
set(LIBTRANSISTOR_NSO_DEPS "${DEVKITPRO2}/lib/libtransistor.nso.a ${LIBTRANSISTOR_COMMON_LIB_DEPS}")
...
set(NRO_COMMAND "python3 ${DEVKITPRO2}/tools/elf2nxo.py <TARGET> <TARGET>.nro nro")
...
set(CMAKE_FIND_ROOT_PATH ${DEVKITPRO2})
