...
set(LIBTRNSSTR "/opt/libtransistor")
set(NX 2)
...
set(SYS_INCLUDES "-isystem ${LIBTRNSSTR}/include/")
set(CPP_INCLUDES "-isystem ${LIBTRNSSTR}/include/c++/v1/")
set(LDFLAGMAIN "-Bsymbolic --shared --no-gc-sections --eh-frame-hdr --no-undefined -T ${LIBTRNSSTR}/link.T -L ${LIBTRNSSTR}/lib/")
set(LDFLAG_LIBRARY "--shared --no-gc-sections --eh-frame-hdr -T ${LIBTRNSSTR}/link.T -L ${LIBTRNSSTR}/lib/ -Bdynamic")
...
#set(PKG_CONFIG "${LIBTRNSSTR}/portlibs/bin/aarch64-none-elf-pkg-config" CACHE STRING "")

set(CMAKE_C_FLAGS "${CC_FLAGS}")
set(CMAKE_CXX_FLAGS "${CXX_FLAGS}" CACHE STRING "C++ flags")


set(LIB_DEP_COMPILER_RT_BUILTINS "${LIBTRNSSTR}/lib/libclang_rt.builtins-aarch64.a")
set(LIB_DEP_NEWLIB_LIBC "${LIBTRNSSTR}/lib/libc.a")
set(LIB_DEP_NEWLIB_LIBM "${LIBTRNSSTR}/lib/libm.a")
set(LIB_DEP_PTHREAD "${LIBTRNSSTR}/lib/libpthread.a")
set(LIB_DEP_LIBLZMA "${LIBTRNSSTR}/lib/liblzma.a")
set(LIB_DEP_LIBCXX "${LIBTRNSSTR}/lib/libc++.a")
set(LIB_DEP_LIBCXXABI "${LIBTRNSSTR}/lib/libc++abi.a")
set(LIB_DEP_LIBUNWIND "${LIBTRNSSTR}/lib/libunwind.a")
set(CXX_LIB_DEPS "${LIB_DEP_LIBCXX} ${LIB_DEP_LIBCXXABI} ${LIB_DEP_LIBUNWIND}")
set(LIBTRANSISTOR_COMMON_LIB_DEPS "${LIB_DEP_NEWLIB_LIBC} ${LIB_DEP_NEWLIB_LIBM} ${LIB_DEP_COMPILER_RT_BUILTINS} ${LIB_DEP_PTHREAD} ${LIB_DEP_LIBLZMA} ${CXX_LIB_DEPS} ${LIBTRNSSTR}/link.T")
set(LIBTRANSISTOR_COMMON_LIBS "${LIBTRANSISTOR_COMMON_LIB_DEPS} # for older Makefiles")
set(LIBTRANSISTOR_NRO_DEP "${LIBTRNSSTR}/lib/libtransistor.nro.a")
set(LIBTRANSISTOR_NSO_DEP "${LIBTRNSSTR}/lib/libtransistor.nso.a")
set(LIBTRANSISTOR_NRO_LIB "${LIBTRANSISTOR_NRO_DEP}")
set(LIBTRANSISTOR_NSO_LIB "${LIBTRANSISTOR_NSO_DEP}")
set(LIBTRANSISTOR_NRO_DEPS "${LIBTRNSSTR}/lib/libtransistor.nro.a ${LIBTRANSISTOR_COMMON_LIB_DEPS}")
set(LIBTRANSISTOR_NSO_DEPS "${LIBTRNSSTR}/lib/libtransistor.nso.a ${LIBTRANSISTOR_COMMON_LIB_DEPS}")
...
set(NRO_COMMAND "python3 ${LIBTRNSSTR}/tools/elf2nxo.py <TARGET> <TARGET>.nro nro")
...
set(CMAKE_FIND_ROOT_PATH ${LIBTRNSSTR})
